...
# Optional DE-IDENTIFIED synthetic follow-up (generated by scripts/make_multi_demo.py).
# When present, the demo session auto-loads it as a 2nd series so Mode B's
# multi-series (baseline vs follow-up) comparison works out of the box. Absent =>
# single-series demo (fully backward compatible).
...
def create_session(layout: str = "bilateral") -> dict:
    ...
    # Auto-load the synthetic follow-up as a 2nd series (baseline vs follow-up) so
    # the multi-series Mode B demo works out of the box. Best-effort: any failure
